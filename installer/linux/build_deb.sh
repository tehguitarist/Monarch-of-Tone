#!/usr/bin/env bash
# Builds a .deb installer for Monarch of Tone's VST3 from an already-built Release artefact.
...
#
# Requires the Monarch_VST3 target to already be built, and dpkg-deb installed.
...
mkdir -p "$OUTDIR"
OUT_DEB="$OUTDIR/Monarch-of-Tone-${VERSION}-Linux-Installer.deb"
