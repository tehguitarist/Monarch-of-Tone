...
- vol/tone/gain knobs = bakeligh_knob.png
- pedal background = MoT_Texture.png
- LEDs = bezel_led_off.png for off, bezel_led_yellow.png for yellow channel on, bezel_led_red.png for red channel on, make this slightly larger than the original part as a glow is built into the image.
...
- presence boost trim knob = trim_knob.png